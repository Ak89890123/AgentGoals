...
from goal_lifecycle import doctor, onboard

LAUNCHER_SCHEMA_VERSION = 1


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog="goal-lifecycle", description="Portable Goal Lifecycle toolkit.")
    parser.add_argument("--version", action="version", version=f"goal-lifecycle {__version__}")
